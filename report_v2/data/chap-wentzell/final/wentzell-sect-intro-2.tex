...
\\\\
We consider a $(d+1)$-dimensional manifold $\mathcal{M}$ (always in Minkowski space-time) for the bulk with a $d$-dimensional time-like boundary $\partial \mathcal{M}$ which is supposed to be static.
