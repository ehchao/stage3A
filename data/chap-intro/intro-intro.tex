...
The idea is to renormalize the vacuum expectation value of current in subtracting the singular part, the \textit{Hadamard parametrix}, which depends locally on geometric data, from itself. 
...
%
On the other hand, boundary conditions could determine how the field is quantized.
...
We can verify that the two-point function defined in the above way satisfies the characteristic of Hadamard state given in~\cite{Radzikowski1996}, \ie
...
Now, we have a Hadamard state and since the singular part of the state, the Hadamard parametrix $H$, is known, we define the vacuum expectation of the current density by 
