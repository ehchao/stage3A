...
Then, for any function $f \in W^{0,2}(\mathcal{M}, \mathbb{C}^2)$, we define the corresponding distribution $T_f$ by
\begin{equation*}
...
After absorbing the shock wave entering the boundary $\delta(x^0+x^2)$,
