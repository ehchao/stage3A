...
\end{equation*}
By adapting time-splitting $x^0 - y^0 = t$, the off-diagonal components of the two-point function are
\begin{equation*}
...
\end{split}
\end{equation*}
With a similar calculation as in~\cref{wen-lemmacvu}, both infinite sums appearing in the last two lines converge uniformly.
