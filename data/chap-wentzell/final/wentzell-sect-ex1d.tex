...
\begin{equation*}
\begin{split}
\rho =& \lim_{t\rightarrow 0} e \bigg(\sum_{k_n>0} |f_n|^2 e^{-ik_nt} 
- \frac{ 1}{ 4L}\sum_{n=1}^{+\infty} e^{-i\frac{1}{2L}(n+\frac 1 2 + \frac{4}{\pi C n}) \pi t} - 1 \bigg) \\
%
...
\Big) \\
& = e \sum_{n=0}^{+\infty}\big(|f_n|^2 -\frac{1}{4L} \big)
\end{split}
\end{equation*}
...
%
=& -\frac{i}{4L^2} \sum_{k_n>0} \Big(\frac n 2 \pi + \frac 1 4 \pi + \mathcal{O}\big(\frac{1}{n^2}\big)\Big) e^{-ik_n(t-i\varepsilon)}
\\
%
...
\bigg(e^{-\frac{i}{2L}\big((n+\frac 1 2 )\pi + \frac{4}{\pi C n} + \mathcal{O}(n^{-3})\big)(t-i\varepsilon)}
...
\begin{equation*}
T_{00} = T_{11}= 2 \sum_{n\geq1} \Big( |f_n|^2 k_n - 
\frac{1}{4L^2}\big(\frac{n\pi}{2} + \frac 1 4 \pi \big) \Big) , \quad
T_{01}=T_{10}  = 0
\end{equation*}
